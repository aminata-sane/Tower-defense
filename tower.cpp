    ...
    : type(type), position(position), target(nullptr), timeSinceLastShot(0.f), level(1)
{
    ...
    case TowerType::MELEE:
        ...
        damage = 20;
        texture.loadFromFile("assets/images/tower_melee.png");
        soundBuffer.loadFromFile("assets/sounds/melee.wav");
        break;
    case TowerType::ARROW:
        ...
        upgradeCost = 50;
        damage = 15;
        texture.loadFromFile("assets/images/tower_arrow.png");
        soundBuffer.loadFromFile("assets/sounds/arrow.wav");
        break;
    case TowerType::FIRE:
        range = 120.f;
        fireRate = 0.6f;
        ...
        upgradeCost = 70;
        damage = 25;
        texture.loadFromFile("assets/images/tower_fire.png");
...
void Tower::updateTexture()
{
    ...
    std::string fullPath = basePath + typeStr;
